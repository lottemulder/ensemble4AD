...
for i in range(0,10):
    ...
    if model_perf > best_model:
        torch.save(model.state_dict(), 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Results_exp3/best-model.pt') 
        best_model = model_perf

# Check accuracy, BCA and mAUC on trianing & test set to see how good model is
model.load_state_dict(torch.load('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Results_exp3/best-model.pt'))
...
results.to_csv('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Results_exp3/results_100_btsr_100p.csv')
TrueFalse.to_csv('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/significance_testing/exp3.csv')
