...
for init_lr, batch_size, n_layers, n_nodes, dropout, nn_type, stop_on_lr_le, epochs_not_best_limit in zip(init_lr_list, batch_size_list, n_layers_list, n_nodes_list, dropout_list, nn_type_list, stop_on_lr_le_list, epochs_not_best_limit_list):
    ...
    while True:
        ...
        if updated:
            torch.load('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp9/best-model.pt')
        ...
        if bca_val > best_val_bca:
            ...
            torch.save(model, 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp9/best-model.pt') 
        ...
        if bca_val > very_best_model:
            ...
            torch.save(model, 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp9/very_best-model.pt') 
...
torch.load('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp9/very_best-model.pt')
model.eval()
_, _, results, TrueFalse, scores = check_accuracy(test_loader, model, which_loader = 'test_loader')

results.to_csv('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp9/results_100_btsr.csv')
TrueFalse.to_csv('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/significance_testing/exp9.csv')
total_scores.to_csv('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp9/total_scores.csv')
