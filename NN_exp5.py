...
# Paths
trainPath = 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/predictions_train_exp5.csv'
trainLabelsPath = 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/true_labels_train_exp5.csv'
valPath = 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/predictions_val_exp5.csv'
valLabelsPath = 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/true_labels_val_exp5.csv'
testPath = 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/predictions_test_exp5.csv'
testLabelPath = 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/true_labels_test_exp5.csv'
...
dropout_list =                  [0.05]
nn_type_list =                  [2]
stop_on_lr_le_list =            [1e-5]
epochs_not_best_limit_list =    [5]
...
for init_lr, batch_size, n_layers, n_nodes, dropout, nn_type, stop_on_lr_le, epochs_not_best_limit in zip(init_lr_list, batch_size_list, n_layers_list, n_nodes_list, dropout_list, nn_type_list, stop_on_lr_le_list, epochs_not_best_limit_list):
    ...
    while True:
        ...
        if updated:
            torch.load('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp5/best-model.pt')
        ...
        if bca_val > best_val_bca:
            ...
            torch.save(model, 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp5/best-model.pt') 
        ...
        if bca_val > very_best_model:
            ...
            torch.save(model, 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp5/very_best-model.pt') 
...
torch.load('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp5/very_best-model.pt')
model.eval()
_, _, results, TrueFalse, total_scores = check_accuracy(test_loader, model, which_loader = 'test_loader')

results.to_csv('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp5/results_100_btsr2.csv')
TrueFalse.to_csv('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/significance_testing/exp5.csv')
total_scores.to_csv('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp5/total_scores.csv')
