...
# Paths
trainPath = 'tadpole_algorithms/tests/Outputs/ResNet/X_TRAIN.csv'
trainLabelsPath = 'tadpole_algorithms/tests/Outputs/ResNet/Y_TRAIN.csv'
valPath = 'tadpole_algorithms/tests/Outputs/ResNet/X_VAL.csv'
valLabelsPath = 'tadpole_algorithms/tests/Outputs/ResNet/Y_VAL.csv'
testPath = 'tadpole_algorithms/tests/Outputs/ResNet/X_TEST.csv'
testLabelPath = 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/true_labels_test_exp51.csv'

# Paths converters
# converters are not used but not yet stratified on converters
USE_CONVERTERS = True
...
batch_size_list =               [30, 10,10,10,10]
n_layers_list =                 [3,10,10,10,10]
n_nodes_list =                  [20,50,50,50,50]
dropout_list =                  [0.05, 0.05, 0.05, 0.05, 0.05]
nn_type_list =                  [4,4,4,4,4]
stop_on_lr_le_list =            [1e-5,1e-5,1e-5,1e-5,1e-5]
epochs_not_best_limit_list =    [10,5,5,5,5]
...
for init_lr, batch_size, n_layers, n_nodes, dropout, nn_type, stop_on_lr_le, epochs_not_best_limit in zip(init_lr_list, batch_size_list, n_layers_list, n_nodes_list, dropout_list, nn_type_list, stop_on_lr_le_list, epochs_not_best_limit_list):
    ...
    filename = 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp5/results_nn_type4_all_data.txt'
    ...
    while True:
        ...
        if updated:
            torch.load('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp8/best-model.pt')
        ...
        if bca_val > best_val_bca:
            ...
            # torch.save(model, 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp8/best-model.pt') 
        ...
        if bca_val > very_best_model:
            ...
            torch.save(model, 'tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp8/very_best-model.pt') 
...
torch.load('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp8/very_best-model.pt')
model.eval()
_, _, results, TrueFalse, scores = check_accuracy(test_loader, model, which_loader = 'test_loader')

results.to_csv('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp8/results_100_btsr.csv')
TrueFalse.to_csv('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/significance_testing/exp8.csv')
total_scores.to_csv('tadpole_algorithms/tests/Outputs/CombinationData/NN_poging2_alles_random_5050split_train_test/Result_exp8/total_scores.csv')
